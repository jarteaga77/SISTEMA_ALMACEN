 ...
 * @author jarteaga
 */
public class ReportesSalidaSistemas 

{
 ...
 // private final String logo="/sysctp/presentacion/recursos/encabezado.png";
    ...
    public void ejecutarReporte(Date fechaIni, Date fechaFin)
    {
        ...
        URL  in = this.getClass().getResource("/MDI/Reportes/sistemas/ReportSalidaSistemas.jasper");
        reporte = (JasperReport) JRLoader.loadObject( in );
        URL  in1 = this.getClass().getResource("/MDI/Reportes/sistemas/SubreporteSalidaSistemas.jasper");//Ruta del reporte maestro

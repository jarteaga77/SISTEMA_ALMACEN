...
package MDI.Reportes.Entradas.Devoluciones;
 ...
 * @author jarteaga
 */
public class ReporteDevoluciones 

{
 ...
 // private final String logo="/sysctp/presentacion/recursos/encabezado.png";
    ...
    public void ejecutarReporte(Date fechaIni, Date fechaFin)
    {
        ...
        URL  in = this.getClass().getResource("/MDI/Reportes/Entradas/Devoluciones/ReportDevoluciones.jasper");
        reporte = (JasperReport) JRLoader.loadObject( in );
        URL  in1 = this.getClass().getResource("/MDI/Reportes/Entradas/Devoluciones/SubreporteDevoluciones.jasper");//Ruta del reporte maestro

 ...
 * @author jarteaga
 */
public class ReportesSalidaMecanica 

{
 ...
 // private final String logo="/sysctp/presentacion/recursos/encabezado.png";
    ...
    public void ejecutarReporte(Date fechaIni, Date fechaFin)
    {
        ...
        URL  in = this.getClass().getResource("/MDI/Reportes/mecanica/ReportSalidaMecanica.jasper");
        reporte = (JasperReport) JRLoader.loadObject( in );
        URL  in1 = this.getClass().getResource("/MDI/Reportes/mecanica/SubreporteSalidaMecanica.jasper");//Ruta del reporte maestro

...
package MDI.Reportes.electrico;
 ...
 * @author jarteaga
 */
public class ReportesSalidaElectrico 

{
 ...
 // private final String logo="/sysctp/presentacion/recursos/encabezado.png";
    ...
    public void ejecutarReporte(Date fechaIni, Date fechaFin)
    {
        ...
        URL  in = this.getClass().getResource("/MDI/Reportes/electrico/ReportSalidaElectrico.jasper");
        reporte = (JasperReport) JRLoader.loadObject( in );
        URL  in1 = this.getClass().getResource("/MDI/Reportes/electrico/SubreporteSalidaElectrico.jasper");//Ruta del reporte maestro
       ...
       //  parametros.put("logo", this.getClass().getResourceAsStream(logo));
         ...
         jviewer.setTitle("Salidas de Almacen--UTD");

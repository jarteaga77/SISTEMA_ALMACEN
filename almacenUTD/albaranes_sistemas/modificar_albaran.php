...
$sel_alb="SELECT * FROM albaranes_sys WHERE codalbaran='$codalbaran'";
$rs_alb=mysql_query($sel_alb);
$codcliente=mysql_result($rs_alb,0,"id_item_tramos");
$iva=mysql_result($rs_alb,0,"iva");
$fecha=mysql_result($rs_alb,0,"fecha");
$req=mysql_result($rs_alb,0,"requisicion");
$sel_cliente="SELECT name_item_tramos FROM item_tramos item JOIN albaranes_sys alba ON alba.id_item_tramos=item.idItem_tramos WHERE alba.codalbaran='$codalbaran'";
$rs_cliente=mysql_query($sel_cliente);
$nombre=mysql_result($rs_cliente,0,"name_item_tramos");
...
$sel_lineas="SELECT * FROM albalinea_sys WHERE codalbaran='$codalbaran' ORDER BY numlinea ASC";
...
while ($contador < mysql_num_rows($rs_lineas)) {
	...
	$sel_tmp="INSERT INTO albalineatmp_sys (codalbaran,numlinea,codfamilia,codigo,cantidad,precio,importe,observacion) VALUES ('$codalbarantmp','','$codfamilia','$codigo','$cantidad','$precio','$importe','$observacion')";
				...
				<form id="formulario" name="formulario" method="post" action="guardar_albaran.php">
                    ...
                    <tr>
						...
						<tr>
					      ...
					      <td colspan="3"><input NAME="codcliente" type="text" class="cajaPequena" id="codcliente" size="6" maxlength="5" readonly value="<? echo $codcliente?>"></td>					
						</tr>
						<tr>
                          ...
                          <tr>  
						    ...
						    <td width="27%"><input NAME="req" type="text" class="cajaMedia" id="req" size="45" maxlength="45" value="<? echo $req ?>"></td>
           </tr>                 

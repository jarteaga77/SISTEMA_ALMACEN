...
$query="SELECT * FROM albaranes_sys WHERE codalbaran='$codalbaran'";
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">VER GUIA DE ORDEN DE SALIDA SISTEMAS </div>
				<div id="frmBusqueda">
						...
						for ($i = 0; $i < mysql_num_rows($rs_lineas); $i++) {
							...
							if ($i % 2) { $fondolinea="itemParTabla"; } else { $fondolinea="itemImparTabla"; } ?>
									<tr class="<? echo $fondolinea?>">
										...
										<td width="12%" class="aCentro"><? echo $importe?></td>
									</tr>

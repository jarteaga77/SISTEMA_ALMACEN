...
if ($cadena_busqueda<>"") {
	...
	$numalbaran=$array_cadena_busqueda[1];
	//$cboEstados=$array_cadena_busqueda[4];
	$fechainicio=$array_cadena_busqueda[2];
	$fechafin=$array_cadena_busqueda[3];
} else {
	//$codcliente="";
	//$nombre="";
	$numalbaran="";
...
<html>
	<head>
		...
		//	var nombre=document.getElementById("nombre").value;
			...
			var cadena="";
			cadena="~"+numalbaran+"~"+fechainicio+"~"+fechafin+"~";
			return cadena;
			}
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">Buscar Guia entrada por reparación</div>
				<div id="frmBusqueda">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=1 border=0>					
						...
						<tr>
						  <td width="20%">Num. Guia Entrada</td>
						  <td width="80%"><input id="numalbaran" type="text" class="cajaPequena" NAME="numalbaran" maxlength="15" value="<? echo $numalbaran?>"></td>
        ...
        <script type="text/javascript">
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
			  	<tr>
				<td width="50%" align="left">N de guia entrada encontrados <input id="filas" type="text" class="cajaPequena" NAME="filas" maxlength="5" readonly></td>
				<td width="50%" align="right">Mostrados <select name="paginas" id="paginas" onChange="paginar()">
		          </select></td>
			  </table>
				</div>
				<div id="cabeceraResultado" class="header">
                                    Relaci&oacute;n de Guia salida </div>
				<div id="frmResultado">
				<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
						<tr class="cabeceraTabla">
							<td width="8%">ITEM</td>
							<td width="8%">N. Entrada</td>
							<td width="29%">Centro de Costo </td>							

...
<html>
	<head>
		...
		function validar_cabecera()
			{
				var mensaje="";
				if (document.getElementById("tec").value=="") mensaje="  - Nombre del Técnico\n";
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm_nf" class="header">CREAR GUIA DE ENTRADA POR REPARACIÖN</div>
				...
				<form id="formulario" name="formulario" method="post" action="guardar_albaran.php">
					...
					button     : "Image1"
                     ...
                     <tr>
						    ...
						    <td width="27%"><input NAME="rem" type="text" class="cajaMedia" id="rem" size="45" maxlength="50" value="REM"></td>
...
<!--				            <td width="3%">RFC</td>
		...
		<tr>
						    ...
						    <td width="27%"><input NAME="tec" type="text" class="cajaMedia" id="tec" size="45" maxlength="45"></td>
						
											<td width="17%">Observaciones</td>

						    <td><textarea name="obse" cols="41" rows="2" id="obse" class="areaTexto"></textarea></td>
                          ...
                          <td width="17%">Cerrar Orden de Entrada.</td>

							<td><select id="cbocerrar" name="cbocerrar" class="comboMedio"  disabled>

							

								<option value="0" >Cerrar Entrada Almacén</option><option value="1">SI</option><option value="2">NO</option>        

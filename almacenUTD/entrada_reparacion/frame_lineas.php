...
if ($modif<>1) {
		...
		if ($retorno==0) {	
				...
				$sel_insert="INSERT INTO linea_ent_repa_tmp (codalbaran,numlinea,codigo,codfamilia,cantidad,observacion) VALUES ('$codalbarantmp','','$codarticulo','$codfamilia','$cantidad','$observacion')";
...
<?php
$sel_lineas="SELECT linea_ent_repa_tmp.*,articulos.*,familias.nombre as nombrefamilia FROM linea_ent_repa_tmp,articulos,familias WHERE linea_ent_repa_tmp.codalbaran='$codalbarantmp' AND linea_ent_repa_tmp.codigo=articulos.codarticulo AND linea_ent_repa_tmp.codfamilia=articulos.codfamilia AND articulos.codfamilia=familias.codfamilia ORDER BY linea_ent_repa_tmp.numlinea ASC";

...
<html>
	<head>
		...
		function hacer_cadena_busqueda() {
			...
			var cadena="";
			cadena="~"+codcliente+"~"+nombre+"~"+numalbaran+"~"+fechainicio+"~"+fechafin+"~";
			return cadena;
			}
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
                                    <div id="tituloForm" class="header">Buscar Guia Devoluci&oacute;n </div>
				<div id="frmBusqueda">
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						...
						<tr>
							<td>Nombre</td>
							<td><input id="nombre" name="nombre" type="text" class="cajaGrande" maxlength="77" value="<? echo $nombre?>"></td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
                                                    <td>Num. guia devoluci&oacute;n</td>
        ...
        <script type="text/javascript">
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
			  	<tr>
                                    <td width="50%" align="left">N de guia devoluci&oacute;n encontrados <input id="filas" type="text" class="cajaPequena" NAME="filas" maxlength="5" readonly></td>
				<td width="50%" align="right">Mostrados <select name="paginas" id="paginas" onChange="paginar()">
		          </select></td>
			  </table>
				</div>
				<div id="cabeceraResultado" class="header">
                                    Relaci&oacute;n de Guia Devoluci&oacute;n </div>
				<div id="frmResultado">
				<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
						<tr class="cabeceraTabla">
							<td width="8%">ITEM</td>
                                                        <td width="8%">N. Guia Devoluci&oacute;n</td>

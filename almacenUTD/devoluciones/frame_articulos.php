...
function pon_prefijo(codfamilia,pref,nombre,codarticulo) {
...
//				$precio=mysql_result($rs_tabla,$i,"precio_almacen");
        ...
        <div align="left"><?php echo $referencia;?></div></td>
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo(<?php echo $codfamilia?>,'<?php echo $referencia?>','<?php echo str_replace('"','',$descripcion)?>',<? echo $codarticulo?>)"><img src="../img/convertir.png" border="0" title="Seleccionar"></a></div></td>					
				</tr>
			<?php }
		?>
  </table>

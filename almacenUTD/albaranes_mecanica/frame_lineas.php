...
if ($modif<>1) {
				...
				}else
		{
				...
				$sel_insert="INSERT INTO linea_hoja_tmp_mec (codalbaran,codigo,codfamilia,cantidad,precio,importe) VALUES ('$codalbarantmp','$codarticulo','$codfamilia','$cantidad','$precio','$importe')";
...
<?php
$sel_lineas="SELECT linea_hoja_tmp_mec.*,articulos.*,familias.nombre as nombrefamilia FROM linea_hoja_tmp_mec,articulos,familias WHERE linea_hoja_tmp_mec.codalbaran='$codalbarantmp' AND linea_hoja_tmp_mec.codigo=articulos.codarticulo AND linea_hoja_tmp_mec.codfamilia=articulos.codfamilia AND articulos.codfamilia=familias.codfamilia ORDER BY linea_hoja_tmp_mec.id_linea_hoja_mto ASC";

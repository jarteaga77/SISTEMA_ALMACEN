...
//subida imagen:
	...
	if (isset($_POST['submit'])) {  
		if(is_uploaded_file($_FILES['foto']['tmp_name'])) { // verifica haya sido cargado el archivo 
			if(move_uploaded_file($_FILES['foto']['tmp_name'], "../fotos_articulos/fotosubida.jpg")) { // se coloca en su lugar final 
			} 
		} 
				...
				<form  action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" align="center"> 
					...
					<table>
					  <tr>
						...
						<td width="100%" ><img src="../fotos_articulos/foto<? echo $codarticulo ?>.jpg" width="250px" height="200px" align="center"></td>
					  </tr>
					  <br>
					  <tr>
					  </table>

...
<html>
	<head>
		...
		function mod_stock(codarticulo,level)
		{
			
			if(level==1 || level==2)
			{
			parent.location.href="modificar_arti_cant.php?codarticulo=" + codarticulo + "&cadena_busqueda=<? echo $cadena_busqueda?>";
			
			}else
			{
				alert("El perfil no permite cambiar la cantidad del insumo");
			}
		}
		
		function modificar_articulo(codarticulo,level) 		{
			...
			{
			alert("El perfil no permite modificación en el insumo");
			}
	...
	function nueva_imagen(codarticulo) {
			parent.location.href="ingresar_imagen.php?codarticulo=" + codarticulo + "&cadena_busqueda=<? echo $cadena_busqueda?>";
		}		
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							<td class="aCentro" width="14%"><? echo $contador+1;?></td>
							<td width="5%"><div align="center"><? echo mysql_result($res_resultado,$contador,"codarticulo")?></div></td>
							<td width="11%"><div align="left"><? echo mysql_result($res_resultado,$contador,"referencia")?></div></td>
							<td width="29%"><div align="left"><? echo mysql_result($res_resultado,$contador,"descripcion")?></div></td>
							...
							<td width="5%"><div align="center"><a href="#"><img src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_articulo(<?php echo mysql_result($res_resultado,$contador,"codarticulo")?>, <? echo $level?>)" title="Modificar"></a></div></td>
                            
             							<td width="5%"><div align="center"><a href="#"><img src="../img/inventario.png" width="16" height="16" border="0" onClick="mod_stock(<?php echo mysql_result($res_resultado,$contador,"codarticulo")?>, <? echo $level ?>)" title="Modificar Stock"></a></div></td>               
   ...
   <td width="5%"><div align="center"><a href="#"><img src="../img/img_change.gif" width="16" height="16" border="0" onClick="nueva_imagen(<?php echo mysql_result($res_resultado,$contador,"codarticulo")?>)" title="Nueva imagen"></a></div></td>                                                      

...
if ($modif<>1) {
		...
		if ($retorno==0) {	
				...
				$sel_insert="INSERT INTO albalineatmp (codalbaran,numlinea,codigo,codfamilia,cantidad,precio,importe,observacion) VALUES ('$codalbarantmp','','$codarticulo','$codfamilia','$cantidad','$precio','$importe','$observacion')";

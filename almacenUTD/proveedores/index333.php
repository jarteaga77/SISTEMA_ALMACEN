...
<html>
	...
	<head>
		...
		<link href="../../Codekamxv16/estilos/estilos.css" type="text/css" rel="stylesheet">
	...
	<body onLoad="inicio()">
		...
		<div id="pagina">
			...
			<div align="center">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="../../Codekamxv16/proveedores/rejilla.php" target="frame_rejilla">
			 	...
			 	<div id="botonBusqueda"><img src="../../Codekamxv16/img/botonbuscar.jpg" width="69" height="22" border="1" onClick="buscar()" onMouseOver="style.cursor=cursor">

			 	  <img src="../../Codekamxv16/img/botonlimpiar.jpg" width="69" height="22" border="1" onClick="limpiar()" onMouseOver="style.cursor=cursor">

					<img src="../../Codekamxv16/img/botonnuevoproveedor.jpg" width="130" height="22" border="1" onClick="nuevo_proveedor()" onMouseOver="style.cursor=cursor">

					<img src="../../Codekamxv16/img/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimir()" onMouseOver="style.cursor=cursor">

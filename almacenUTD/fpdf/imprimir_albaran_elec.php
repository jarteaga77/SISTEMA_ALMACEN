...
$consulta = "SELECT CONCAT(cc.sigla_ccostos,' - ', tr.name_tramo,' - ',item.name_item_tramos) AS destino, al.fecha, us.full_name,al.transporta_reviza,al.recibe,al.observacion FROM albaranes_elec al 
...
//    $pdf->Ln(4);
    ...
    $pdf->Cell(80);
    $pdf->Cell(50,5,'REMISIONES ELECTRICOS',1,0,'C');
    $pdf->Ln(10);
...
//	$pdf->Cell(30,4,$lafila["id_ccostos"],1,0,'C',1);
	...
	$consulta2 = "Select * from albalinea_elec where codalbaran='$codalbaran' order by numlinea";
	...
	while ($row=mysql_fetch_array($resultado2))
	{
      ...
      $pdf->Cell(15,4,mysql_result($rs_articulos,0,utf8_decode("nombre")),0,'L');

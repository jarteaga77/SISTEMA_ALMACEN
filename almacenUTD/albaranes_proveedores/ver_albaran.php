...
$remision= mysql_result($rs_query, 0, "remision_factura");
$requi=  mysql_result($rs_query,0,"requisicion");
$orden=  mysql_result($rs_query,0,"orden_compra");
$codcliente=mysql_result($rs_query,0,"id_ccostos");
$iva=mysql_result($rs_query,0,"iva");
$compras=mysql_result($rs_query,0,"compras");
?>
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">VER ENTRADA ALMACEN</div>
				<div id="frmBusqueda">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<? 
						 $sel_cliente="SELECT * FROM proveedores WHERE codproveedor='$codproveedor'"; 
						  $rs_cliente=mysql_query($sel_cliente);
                                                 ...
                                                 $sel_centro="SELECT item.id_item_ccostos,CONCAT(centro.nombre_ccostos, '-',  item.nombre_item_ccostos) AS nombre FROM 
						  ...
						  $rs_centro=mysql_query($sel_centro); ?>
                                            
                         <tr>
						  <td>C&oacute;digo de Entrada Almacen</td>
					  ...
					  <tr>
						  ...
						  <td colspan="2"><?php echo mysql_result($rs_centro,0,"nombre");?> </td>
					  </tr>
                                          
                                                 <tr>
						  <td>Compras</td>
						  <td colspan="2"><?php echo $compras?> </td>
					  </tr>
					  ...
					  <tr>
						  ...
						  <td colspan="2"><?php echo $iva?> %</td>
                                            ...
                                            <tr>
							<td width="15%">Remisi&oacute;n / Factura</td>
						    <td width="85%" colspan="2"><?php echo $remision;?></td>
					    </tr>
                                            <tr>
							<td width="15%">Requisici&oacute;n</td>
						    <td width="85%" colspan="2"><?php echo $requi;?></td>
					    </tr>
                                            
                                            <tr>
							<td width="15%">Orden de Compra</td>
						    <td width="85%" colspan="2"><?php echo $orden;?></td>
					    </tr>

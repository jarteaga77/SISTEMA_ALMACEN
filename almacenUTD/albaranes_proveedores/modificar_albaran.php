...
<html>
	<head>
		...
		{
			var level=level;		
			if(level ==6  || level==9|| level==1 || level==2 || level==7 || level==3 || level==7)
			{
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">MODIFICAR ENTRA DE ALMACEN</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_albaran.php">
                    ...
                    <tr>
						...
						<tr>
					      ...
					      <td colspan="3"><input NAME="codproveedor" type="text" class="cajaPequena" id="codproveedor" size="6" maxlength="5" value="<? echo $codproveedor?>" readonly></td>					
						</tr>
						<tr>

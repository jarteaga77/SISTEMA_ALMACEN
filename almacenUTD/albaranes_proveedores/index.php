...
<html>
	<head>
		...
		function hacer_cadena_busqueda() {
			...
			var cadena="";
			cadena="~"+codproveedor+"~"+nombre+"~"+numalbaran+"~"+fechainicio+"~"+fechafin+"~";
			return cadena;
			}
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">Buscar Entrada Almacen </div>
				<div id="frmBusqueda">
        ...
        <script type="text/javascript">
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
				...
				<div id="cabeceraResultado" class="header">
					Relaci&oacute;n Entrada Almacen </div>
				<div id="frmResultado">

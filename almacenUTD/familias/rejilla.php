				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							<td class="aCentro" width="19%"><? echo $contador+1;?></td>
							<td width="18%"><div align="center"><? echo mysql_result($res_resultado,$contador,"codfamilia")?></div></td>
							<td width="49%"><div align="left"><? echo mysql_result($res_resultado,$contador,"nombre")?></div></td>
							<td width="7%"><div align="center"><a href="#"><img src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_familia(<?php echo mysql_result($res_resultado,$contador,"codfamilia")?>)" title="Modificar"></a></div></td>
														<td width="7%"><div align="center"><a href="#"><img src="../img/ver.png" width="16" height="16" border="0" onClick="ver_familia(<?php echo mysql_result($res_resultado,$contador,"codfamilia")?>)" title="Visualizar"></a></div></td>

...
if ($modif<>1) {
		...
		if ($retorno==0) {	
				...
				$sel_insert="INSERT INTO albalineatmp_elec (codalbaran,numlinea,codigo,codfamilia,cantidad,precio,importe,observacion) VALUES ('$codalbarantmp','','$codarticulo','$codfamilia','$cantidad','$precio','$importe','$observacion')";
...
<?php
$sel_lineas="SELECT albalineatmp_elec.*,articulos.*,familias.nombre as nombrefamilia FROM albalineatmp_elec,articulos,familias WHERE albalineatmp_elec.codalbaran='$codalbarantmp' AND albalineatmp_elec.codigo=articulos.codarticulo AND albalineatmp_elec.codfamilia=articulos.codfamilia AND articulos.codfamilia=familias.codfamilia ORDER BY albalineatmp_elec.numlinea ASC";
